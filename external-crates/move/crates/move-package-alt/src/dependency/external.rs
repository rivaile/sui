...
/// Resolve the requests in [requests] with the external resolver [resolver]. Ensures that the
/// returned dependency set contains no externally resolved dependencies.
