...
use crate::workloads::multiparty::MultipartyWorkloadBuilder;
...
impl WorkloadConfiguration {
    ...
    pub async fn create_workload_builders(
        ...
        let multiparty_workload = MultipartyWorkloadBuilder::from(
            weights.multiparty as f32 / total_weight as f32,
            target_qps,
            num_workers,
            in_flight_ratio,
            duration,
        ...
        workload_builders.push(multiparty_workload);
        workload_builders
    }
}
